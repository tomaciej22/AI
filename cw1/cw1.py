...
#         print(f'Cały plik: {df[kolumny].std()}')
#         print(f'Klasy decyzyjne: {df.groupby("Exited")[kolumny].std()}\n')

#zad4a
# print("zad4a\n")
# df = pd.read_csv('Churn_Modelling.csv')
# kolumna = df.columns.tolist()
...
# if df[liczba_brakujacych_wierszy].dtype == 'float64':
#     atrybut_numeryczny = df[liczba_brakujacych_wierszy].mean()
#     df[liczba_brakujacych_wierszy].fillna(atrybut_numeryczny, inplace=True)
# else:
#     atrybut_symboliczny = df[liczba_brakujacych_wierszy].mode()[0]
#     df[liczba_brakujacych_wierszy].fillna(atrybut_symboliczny, inplace=True)
...
#
# znormalizowane_wartosci_atrybutu('Churn_Modelling.csv', 1, -1, 1) # <-1,1>
...
# standaryzacja('Churn_Modelling.csv', 4)
...
# standaryzacja('Churn_Modelling.csv',3)

#zad4d
# print("zad4d\n")
# dane = pd.read_csv('Churn_Modelling.csv')
#
